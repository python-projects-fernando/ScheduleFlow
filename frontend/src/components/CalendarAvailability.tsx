...
const mockAvailabilityData: GetAvailabilityResponse = {
  ...
  time_slots: [
    ...
    { start: "2025-11-30T10:00:00.000Z", end: "2025-11-30T10:30:00.000Z", is_available: false },
    ...
    { start: "2025-11-30T14:30:00.000Z", end: "2025-11-30T15:00:00.000Z", is_available: false },
    ...
    { start: "2025-12-01T15:00:00.000Z", end: "2025-12-01T15:30:00.000Z", is_available: false },
    { start: "2025-12-02T09:00:00.000Z", end: "2025-12-02T09:30:00.000Z", is_available: false },
    { start: "2025-12-02T09:30:00.000Z", end: "2025-12-02T10:00:00.000Z", is_available: false },
    { start: "2025-12-02T16:00:00.000Z", end: "2025-12-02T16:30:00.000Z", is_available: false },
    ...
    { start: "2025-12-03T12:00:00.000Z", end: "2025-12-03T12:30:00.000Z", is_available: false },
    ...
    { start: "2025-12-05T10:00:00.000Z", end: "2025-12-05T10:30:00.000Z", is_available: false },
...
const CalendarAvailability: React.FC = () => {
  ...
  const [searchStartDateISO, setSearchStartDateISO] = useState<Date>(new Date());
  const [searchEndDateISO, setSearchEndDateISO] = useState<Date | null>(null);
